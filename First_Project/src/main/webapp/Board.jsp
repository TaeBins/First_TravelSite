   ...
   <header class="main_menu">
    ...
    <section class="contact-section">
        <div class="container" align="center">
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Get in Board</h2>
                </div>
                <div class="col-lg-8">
                    <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <input class="form-control" name="name" id="name" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" placeholder='Enter your Nick'>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mt-3">
                            <button type="submit" class="button button-contactForm btn_1">Upload</button>
                        </div>
                    </form>
                </div>
            </div>
