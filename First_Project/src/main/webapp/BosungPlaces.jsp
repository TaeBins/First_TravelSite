    ...
    <section class="top_place section_padding">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="img2/places/GreenTea1.jpg" width="555px" height="396px">
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="single_place">
                        <img src="img2/places/Yulpo1.jpg" width="555px" height="396px">
                        <div class="hover_Text d-flex align-items-end justify-content-between">
                            <div class="hover_text_iner">
                                <h3>Yulpo Beach</h3>
                                <p>Jeollanam-do, Korea</p>
                ...
                <div class="col-lg-6 col-md-6">
           		...
           		<div align="center">
	           		<button class="morebut"><a href="Bosungphoto.jsp" target="_blank">MorePhoto</a></button>
	           	</div>
        </div>
    </section>
    <!-- hotel list css end -->
