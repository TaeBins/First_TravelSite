				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Why.jsp"><img src="img1/rest/b1-4.jpg"></a>
								</div>
							</div>
						</div>
						...
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Why.jsp">Whyseo House</a>
							</h3>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Bakery.jsp"><img src="img1/rest/b2-7.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Bakery.jsp">Mori's Bakery</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Yulpobot.jsp"> <img src="img1/rest/b3-5.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Yulpobot.jsp">Yulpobot Jae Garden</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Daewonjeong.jsp"><img src="img1/rest/b4-2.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Daewonjeong.jsp">Daewonjeong</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Chununseook.jsp"><img src="img1/rest/b5-3.jpg"></a>
								</div>
							</div>
						</div>
						...
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Chununseook.jsp">Chununseook</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Teugmigwan.jsp"> <img src="img1/rest/b6-3.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Teugmigwan.jsp">Teugmigwan</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
