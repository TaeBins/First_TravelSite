...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='img1/Gwangju/대인야시장142.jpg' alt='Buns' title='1' />
			</li>
			<li class='num1 img'>
				 <img src='img1/Gwangju/대인야시장177.jpg' alt='Croissant' title='2' /> 
			</li>
			<li class='num2 img'>
				 <img src='img1/Gwangju/대인야시장179.jpg' alt='Lemon pie' title='3' />
			</li>
		</ul>
