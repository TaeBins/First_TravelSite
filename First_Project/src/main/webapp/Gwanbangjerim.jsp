...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='img1/Damyang/관방제림1.jpg' alt='Buns' title='1' /> 
			</li>
			<li class='num1 img'>
				 <img src='img1/Damyang/관방제림26.jpg' alt='Croissant' title='2' /> 
			</li>
			<li class='num2 img'>
				 <img src='img1/Damyang/관방제림2.png' alt='Lemon pie' title='3' /> 
			</li>
		</ul>
