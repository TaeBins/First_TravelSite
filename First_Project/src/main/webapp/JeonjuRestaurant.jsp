				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Sister.jsp"><img src="img1/rest/j1-5.jpg"></a>
								</div>
							</div>
						</div>
						...
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Sister.jsp">Sister Galbi Hot Pot</a>
							</h3>
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Veteran.jsp"><img src="img1/rest/j2-5.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Veteran.jsp">Veteran Kalguksu</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/House.jsp"> <img src="img1/rest/j3-3.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/House.jsp">Korean House</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/Jeolla.jsp"><img src="img1/rest/j4-7.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/Jeolla.jsp">Jeolla-do Food Story</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/GoGung.jsp"><img src="img1/rest/j5-2.jpg"></a>
								</div>
							</div>
						</div>
						...
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/GoGung.jsp">GoGung</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
				...
				<div class="col-lg-4 col-sm-6">
					<div class="single_ihotel_list">
						<div class="container">
							<div class="thumbex">
								<div class="thumbnail">
									<a href="rest/A.jsp"> <img src="img1/rest/j7-5.jpg"></a>
								</div>
							</div>
						</div>
						<div class="hotel_text_iner">
							<h3>
								<a href="rest/A.jsp">A hut next to the train track</a>
							</h3>
							<form action="wishCon.do">
                            	<button type="button" class="btn btn-outline-danger">
               							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
