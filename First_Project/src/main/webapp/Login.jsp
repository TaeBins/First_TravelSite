    ...
    <div class = "login-form">
	    	...
	    	<div align="center">
		    	<form action="LoginCon.do" method="post">
		    		<input type = "text" name="mb_id" class = "tepw-field" placeholder="아이디">
		    		<input type = "password" name="mb_pw" class = "tepw-field" placeholder="비밀번호">
		    	...
		    	<div class = "login-links">
		    		<a href="Idselect.jsp">아이디 찾기</a>
		    		<a> | </a>
		    		<a href="Pwselect.jsp">비밀번호 찾기</a>
		    	</div>
	    	</div>
    </div>
