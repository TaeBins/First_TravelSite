                ...
                <div class="row align-items-center ">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            if (log == null) {%>
                            <a href="Login.jsp"><i class="bi bi-box-arrow-in-right"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img2/services_1.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img2/services_2.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img2/services_3.png" alt="">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_ihotel_list">
                        <img src="img2/services_4.png" alt="">
