	...
	<div class="pwselect-form">
		...
		<div align="center">
			<form action="PwCheckCon.do" method="post">
				...
				<br> <input type="text" name="mb_pw" class="join-fieldeds" placeholder="비밀번호"> <input type="hidden" name="mb_id" value="<%=log.getMb_id()%>"> <br> <input type="submit" class="pwsubmit-btn" value="확인하기">
			</form>
		</div>
	</div>
