...
<body>
	...
	<main>
		<div class="slideshow" tabindex="0">
			<div class="slide slide--layout-1" data-layout="layout1">
				<div class="slide-imgwrap">
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수세계박람회장2.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수세계박람회장56.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수세계박람회장85.jpg);"></div>
					</div>
				</div>
			...
			<div class="slide slide--layout-4" data-layout="layout4">
				<div class="slide-imgwrap">
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수해상케이블카2.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수해상케이블카4.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수해상케이블카26.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수해상케이블카27.jpg);"></div>
					</div>
				</div>
				<div class="slide__title">
			...
			<div class="slide slide--layout-5" data-layout="layout5">
				<div class="slide-imgwrap">
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다7.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다8.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다11.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다20.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다28.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다32.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다34.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다36.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다41.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다49.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다62.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다67.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다68.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다73.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다74.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다77.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다78.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수밤바다80.jpg);"></div>
					</div>
				</div>
				<div class="slide__title">
			...
			<div class="slide slide--layout-6" data-layout="layout6">
				<div class="slide-imgwrap">
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수오동도0.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수오동도10.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수오동도23.jpg);"></div>
					</div>
				</div>
				<div class="slide__title">
			...
			<div class="slide slide--layout-7" data-layout="layout7">
				<div class="slide-imgwrap">
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수금오도7.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수금오도20.jpg);"></div>
					</div>
					<div class="slide__img">
						<div class="slide__img-inner" style="background-image: url(img1/Yeosu/여수금오도68.jpg);"></div>
					</div>
				</div>
				<div class="slide__title">
			...
			<nav class="slideshow__nav slideshow__nav--arrows">
				<button id="prev-slide" class="btntntn btntntn--arrow" aria-label="Previous slide">
					<svg class="icon icon--prev">
						<use xlink:href="#icon-prev"></use></svg>
				</button>
				<button id="next-slide" class="btntntn btntntn--arrow" aria-label="Next slide">
	...
	<script>
		(function() {
			var slideshow = new MLSlideshow(document
