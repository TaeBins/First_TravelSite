...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <a href="http://cssslider.com" target=""><img src='img1/Damyang/용마루1.jpg' alt='Buns' title='1' /> </a> 
			</li>
			<li class='num1 img'>
				 <a href="http://cssslider.com" target=""><img src='img1/Damyang/용마루2.jpg' alt='Croissant' title='2' /> </a> 
			</li>
			<li class='num2 img'>
				 <a href="http://cssslider.com" target=""><img src='img1/Damyang/용마루3.jpg' alt='Lemon pie' title='3' /> </a> 
			</li>
		</ul>
		...
		<div class='cs_bullets'>
			<label class='num0' for='cs_slide1_0'>
				...
				<span class='cs_thumb'><img src='img1/Damyang/용마루1.jpg' alt='Buns' title='1' /></span>
			</label>
			<label class='num1' for='cs_slide1_1'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='img1/Damyang/용마루2.jpg' alt='Croissant' title='2' /></span>
			</label>
			<label class='num2' for='cs_slide1_2'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='img1/Damyang/용마루3.jpg' alt='Lemon pie' title='3' /></span>
			</label>
		</div>
	</div>
		<div class="dede"></div>
	...
	<table class="container">
		<tbody>
			...
			<td class="tdtdtd">전남 담양군 용면 용연리 산305</td>
			</tr>
			<tr>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('전남 담양군 용면 용연리 산305', function(result, status) {
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding: 3px 0;">용마루길</div>'
        });
