...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='../img1/Jindo/진도개테마파크149.jpg' alt='Buns' title='1' /> 
			</li>
			<li class='num1 img'>
				 <img src='../img1/Jindo/진도개테마파크20.jpg' alt='Croissant' title='2' /> 
			</li>
			<li class='num2 img'>
				 <img src='../img1/Jindo/개.jpg' alt='Lemon pie' title='3' />
			</li>
		</ul>
