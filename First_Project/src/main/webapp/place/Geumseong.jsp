					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/Damyang/금성산성11.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/Damyang/금성산성2.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/Damyang/금성산성3.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
			...
			<tbody>
				...
				<td class="tdtdtd">
					<form action="WishCon.do" method="post">
						<input type="hidden" name="place_seq" value="<%=18%>">
