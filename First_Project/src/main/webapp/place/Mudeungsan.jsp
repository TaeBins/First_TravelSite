...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='../img1/Gwangju/무등산16.jpg' alt='Buns' title='1' />
			</li>
			<li class='num1 img'>
				 <img src='../img1/Gwangju/무등산19.jpg' alt='Croissant' title='2' />
			</li>
			<li class='num2 img'>
				 <img src='../img1/Gwangju/무등산21.jpg' alt='Lemon pie' title='3' />
			</li>
		</ul>
