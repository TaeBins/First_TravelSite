					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/Gwangju/국아문10.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/Gwangju/국아문164.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/Gwangju/국아문172.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
