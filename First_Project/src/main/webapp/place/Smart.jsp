					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/Gwangju/스마트인재개발원0.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/Gwangju/스마트인재개발원119.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/Gwangju/스마트인재개발원88.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
							...
							<div class='cs_bullets'>
								<label class='num0' for='cs_slide1_0'> <span class='cs_point'></span> <span class='cs_thumb'>
										<img src='../img1/Gwangju/스마트인재개발원0.jpg' alt='Buns' title='1' />
									</span>
								</label> <label class='num1' for='cs_slide1_1'> <span class='cs_point'></span> <span class='cs_thumb'>
										<img src='../img1/Gwangju/스마트인재개발원119.jpg' alt='Croissant' title='2' />
									</span>
								</label> <label class='num2' for='cs_slide1_2'> <span class='cs_point'></span> <span class='cs_thumb'>
										<img src='../img1/Gwangju/스마트인재개발원88.jpg' alt='Lemon pie' title='3' />
									</span>
								</label>
							</div>
						</div>
			...
			<tbody>
				...
				<td class="tdtdtd">
					<form action="WishCon.do" method="post">
						<input type="hidden" name="place_seq" value="<%=8%>">
