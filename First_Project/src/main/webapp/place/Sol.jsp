					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/Jindo/soso4.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/Jindo/soso5.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/Jindo/soso8.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
							...
							<div class='cs_bullets'>
								<label class='num0' for='cs_slide1_0'> <span class='cs_point'></span> <span class='cs_thumb'>
										...
										<img src='../img1/Jindo/soso4.jpg' alt='Croissant' title='2' />
									</span>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">Jeonnam Jindogun Uisinmyeon Song-gungil 30-40</td>
				</tr>
				<tr>
					<th class="ththth">Parking</th>
					<td class="tdtdtd">reservation</td>
				</tr>
				<tr>
					<th class="ththth">Tel</th>
					<td class="tdtdtd">02-1588-4888</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="WishCon.do" method="post">
						<input type="hidden" name="place_seq" value="<%=25%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding: 3px 0;">Sol Beach</div>'
										});
