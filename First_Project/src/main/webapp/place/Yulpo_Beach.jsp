...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='../img1/Bosung/보성율포해수욕장3.jpg' alt='Buns' title='1' />
			</li>
			<li class='num1 img'>
				 <img src='../img1/Bosung/보성율포해수욕장32.jpg' alt='Croissant' title='2' />
			</li>
			<li class='num2 img'>
				 <img src='../img1/Bosung/보성율포해수욕장52.jpg' alt='Lemon pie' title='3' />
			</li>
		</ul>
