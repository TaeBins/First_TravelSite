					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/b2-2.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/b2-3.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/b2-6.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 보성군 벌교읍 태백산맥길 406</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">10:30 ~ 15:30</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">061-858-2623</td>
				</tr>
				<tr>
					<th class="ththth">휴무</th>
					<td class="tdtdtd">매주 월,화요일</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=26%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding: 3px 0;">모리씨빵가게</div>'
										});
