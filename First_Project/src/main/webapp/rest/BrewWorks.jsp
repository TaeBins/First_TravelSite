					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/s3-3.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/s3-4.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/s3-7.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 순천시 역전길 61</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tdtdtd">0507-1334-2545</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=39%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:180px;text-align:center;padding: 3px 0;">브루웍스</div>'
										});
