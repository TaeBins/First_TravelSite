					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/g7-3.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/g7-6.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/g7-7.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 진도군 진도읍 서문길 8-21 1층</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tdtdtd">061-542-3335</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=24%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding: 3px 0;">달님이네</div>'
										});
