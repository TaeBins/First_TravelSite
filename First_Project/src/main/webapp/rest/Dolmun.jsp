					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/y7-2.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/y7-4.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/y7-6.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 여수시 하멜로 78</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">12:00 ~ 23:00</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">061-665-4595</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=36%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding: 3px 0;">돌문어 상회</div>'
										});
