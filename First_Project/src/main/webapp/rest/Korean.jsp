					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/y2-6.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/y2-5.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/y2-7.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 여수시 시청동5길 23 한식의 정석 한식정</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">00:00 ~ 24:00</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">0507-1447-0721</td>
				</tr>
				<tr>
					<th class="ththth">휴무</th>
					<td class="tdtdtd">연중무휴</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=32%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:180px;text-align:center;padding: 3px 0;">한식의정석</div>'
										});
