					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/k2-3.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/k2-5.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/k2-6.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">광주 서구 상무자유로 180 대선빌딩 1F</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">11:30 ~ 21:20</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">0507-1349-7501</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=2%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:180px;text-align:center;padding: 3px 0;">나나방콕</div>'
										});
