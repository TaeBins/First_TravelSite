...
<body>
					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/k4-4.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/k4-5.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/k4-6.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">광주 광산구 임방울대로826번길 42 포플레이첨단 Lounge OIC(1층 레드카펫 출입구)</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">12:00 ~ 24:00</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">0507-1475-9912</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=5%>">
	...
	<script>
		...
		geocoder
				.addressSearch(
						'광주 광산구 임방울대로826번길 42 포플레이첨단 Lounge OIC(1층 레드카펫 출입구)',
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:180px;text-align:center;padding: 3px 0;">Lounge OIC</div>'
										});
