					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/d5-2.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/d5-3.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/d5-4.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">전남 담양군 고서면 원등1길 16-7 고서회관</td>
				</tr>
				<tr>
					<th class="ththth">영업시간</th>
					<td class="tdtdtd">11:30 ~ 15:00</td>
				</tr>
				<tr>
					<th class="ththth">전화번호</th>
					<td class="tdtdtd">0507-1339-1489</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=17%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:150px;text-align:center;padding: 3px 0;">고서회관</div>'
										});
