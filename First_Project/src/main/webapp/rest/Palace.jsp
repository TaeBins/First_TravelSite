					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/k5-3.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/k5-4.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/k5-5.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
		...
		<table class="container">
			<tbody>
				<tr>
					...
					<td class="tdtdtd">광주 동구 충장로 93-6</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="tdtdtd">062-222-3477</td>
				</tr>
				<tr>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=4%>">
						...
						function(result, status) {
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow(
										{
											content : '<div style="width:180px;text-align:center;padding: 3px 0;">궁전제과</div>'
										});
