...
<!-- Start cssSlider.com -->
	<div class='csslider1 autoplay'>
		...
		<ul>
			...
			<li class='num0 img'>
				 <img src='../img1/rest/g1-4.jpg' alt='Buns' title='1' />
			</li>
			<li class='num1 img'>
				 <img src='../img1/rest/g1-5.jpg' alt='Croissant' title='2' />
			</li>
			<li class='num2 img'>
				 <img src='../img1/rest/g1-7.jpg' alt='Lemon pie' title='3' /> 
			</li>
		</ul>
		...
		<div class='cs_bullets'>
			<label class='num0' for='cs_slide1_0'>
				...
				<span class='cs_thumb'><img src='../img1/rest/g1-4.jpg' alt='Buns' title='1' /></span>
			</label>
			<label class='num1' for='cs_slide1_1'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='../img1/rest/g1-5.jpg' alt='Croissant' title='2' /></span>
			</label>
			<label class='num2' for='cs_slide1_2'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='../img1/rest/g1-7.jpg' alt='Lemon pie' title='3' /></span>
			</label>
		</div>
	</div>
		<div class="dede"></div>
	...
	<table class="container">
		<tbody>
			...
			<td class="tdtdtd">0507-1413-4449</td>
			</tr>
			<tr>
			<th class="ththth">휴무</th>
			<td class="tdtdtd">매달 첫째주 화요일</td>
			</tr>
			<tr>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('전남 진도군 진도읍 남동1길 66', function(result, status) {
    ...
    // 정상적으로 검색이 완료됐으면 
     if (status === kakao.maps.services.Status.OK) {
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding: 3px 0;">신호등회관</div>'
        });
