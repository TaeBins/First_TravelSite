					...
					<div class="section_tittle text-center" style="width: 700px;">
						...
						<div class='csslider1 autoplay'>
							...
							<ul>
								...
								<li class='num0 img'><img src='../img1/rest/g3-3.jpg' alt='Buns' title='1' /></li>
								<li class='num1 img'><img src='../img1/rest/g3-4.jpg' alt='Croissant' title='2' /></li>
								<li class='num2 img'><img src='../img1/rest/g3-5.jpg' alt='Lemon pie' title='3' /></li>
							</ul>
			...
			<tbody>
				...
				<td class="tdtdtd">
					<form action="RWishCon.do" method="post">
						<input type="hidden" name="rest_seq" value="<%=21%>">
